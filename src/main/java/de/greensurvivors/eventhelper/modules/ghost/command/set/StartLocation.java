...
public class StartLocation extends AGameSubCmd {

    public StartLocation(@NotNull EventHelper plugin, @Nullable Permission permission) {
        super(plugin, permission);
    }

    @Override
    public @NotNull Set<@NotNull String> getAliases() {
        return Set.of("startlocation");
    }
