...
public class JoinSubCmd extends AGameSubCmd {
    protected final @NotNull GhostModul ghostModul;

    public JoinSubCmd(@NotNull EventHelper plugin, final @NotNull GhostModul ghostModul, @Nullable Permission permission) {
    ...
    public boolean hasPermission(final @NotNull Permissible permissible) {
        return permissible.hasPermission(permission) || permissible.hasPermission(GhostModul.getJoinPermission());
    }
